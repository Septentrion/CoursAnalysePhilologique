...
3. Afficher uneimage avec le masque correspondant
4. Entraîner un modèle à partir du jeu de données
5. Faire des prédictions à partir d'images de kangourous inconnues
